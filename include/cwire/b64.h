...
static inline const char* cwr_base64_select_table (cwr_b64_mode mode) 
{
    switch (mode) 
    {
...
static inline const size_t cwr_base64_encoded_size (size_t size, cwr_b64_mode mode) 
{
...
static inline const size_t cwr_base64_decoded_size_fast (size_t size) 
{
